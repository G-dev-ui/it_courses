...
public class LibrariesForLibsInPluginsBlock extends AbstractExternalDependencyFactory {
    ...
    private final AdapterdelegatesLibraryAccessors laccForAdapterdelegatesLibraryAccessors = new AdapterdelegatesLibraryAccessors(owner);
    ...
    /**
     * Group of libraries at <b>adapterdelegates</b>
     *
     * @deprecated Will be removed in Gradle 9.0.
     */
    @Deprecated
    public AdapterdelegatesLibraryAccessors getAdapterdelegates() {
        org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
        return laccForAdapterdelegatesLibraryAccessors;
    }
     ...
     */
    @Deprecated
    public static class AdapterdelegatesLibraryAccessors extends SubDependencyFactory {

        public AdapterdelegatesLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Dependency provider for <b>kotlin</b> with <b>com.hannesdorfmann:adapterdelegates4-kotlin-dsl</b> coordinates and
        ...
        public Provider<MinimalExternalModuleDependency> getKotlin() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return create("adapterdelegates.kotlin");
        }

        /**
         * Dependency provider for <b>viewbinding</b> with <b>com.hannesdorfmann:adapterdelegates4-kotlin-dsl-viewbinding</b> coordinates and
         * with version reference <b>adapterDelegates</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         *
        ...
        public Provider<MinimalExternalModuleDependency> getViewbinding() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return create("adapterdelegates.viewbinding");
        }
    ...
    public static class VersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>adapterDelegates</b> with value <b>4.3.2</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
