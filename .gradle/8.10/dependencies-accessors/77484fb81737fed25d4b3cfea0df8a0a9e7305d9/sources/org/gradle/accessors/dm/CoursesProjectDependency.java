...
@NonNullApi
public class CoursesProjectDependency extends DelegatingProjectDependency {

    @Inject
    public CoursesProjectDependency(TypeSafeProjectDependencyFactory factory, ProjectDependencyInternal delegate) {
