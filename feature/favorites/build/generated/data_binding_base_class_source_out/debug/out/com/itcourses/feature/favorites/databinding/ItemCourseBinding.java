...
package com.itcourses.feature.favorites.databinding;
...
public final class ItemCourseBinding implements ViewBinding {
  ...
  private ItemCourseBinding(@NonNull ConstraintLayout rootView, @NonNull TextView description,
      @NonNull ImageButton like, @NonNull TextView price, @NonNull TextView title) {
  ...
  public static ItemCourseBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ItemCourseBinding((ConstraintLayout) rootView, description, like, price, title);
    }
