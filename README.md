...
- **Главная**: поиск/сортировка и список курсов (карточки с изображением, рейтингом, датой, описанием и ценой). В каждой карточке — действие **“Подробнее”** со стрелкой и кнопка добавления в избранное.
- **Экран курса**: обложка, действия, блок автора, кнопки действий и описание “О курсе”, а также кнопка добавления/удаления из избранного.
- **Избранное**: список курсов, добавленных в избранное.
- **Профиль**: меню действий + “Ваши курсы” со списком и прогрессом прохождения, с отображением статуса избранного.
- **Синхронизация избранного**: изменение статуса курса (добавить/убрать) сразу отражается на всех экранах.
...
- **DI**: Koin
- **Сеть/данные**: Retrofit + OkHttp + Moshi, Room (локальное избранное)
...
- **`core:database`**
  - Room Database + DAO для хранения избранного (single source of truth для статуса избранного)
- **`core:network-mock`**
